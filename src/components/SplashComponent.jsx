...
const SplashComponent = () => {
  return (
    ...
    <div className='flex justify-center'>
      ...
      <p className="absolute md:bottom-28 bottom-[30%] md:left-20  md:bg-black/65 bg-white/15 backdrop-blur-sm font-normal text-white text-5xl p-4 md:rounded-none rounded-md">Cookware Built To Last</p>
    </div>
    </div>
    <div>
